    ...
    plugins: [
      ...
      extraPages({
        ...
        pages: [
          ...
          },
          {
            ...
            transforms: [
              ({ source, ...data }) => {
                ...
                const manpage = fs.existsSync(`src/assets/manual/${basename}.html`)
          ...
          {
            // Puzzle manual, generated by scripts/build-manual.sh (halibut)
            sources: "src/assets/manual/**/*.html",
            resolve: { url: "help/manual/", path: "src/assets/manual/" },
            transforms: [
