...
what is outlined, what carries an ordinal — and treat colour as a secondary cue,
because shape is what the games are held to and what survives for a colourblind
player.
...
- **AND** it identifies the mark by shape first, with colour as a secondary cue
