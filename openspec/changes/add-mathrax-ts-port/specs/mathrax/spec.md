# mathrax Specification Delta — add-mathrax-ts-port
...
given digits and clues in a randomised order while the puzzle remains solvable at the
target difficulty. Generation from a given seed SHALL be reproducible.
