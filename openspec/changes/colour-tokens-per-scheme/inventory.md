...
**Totals:** 687 palette entries across 57 games. 497 (72%) are a token from the table. 116 (70 distinct values) are still written as literals in a game, and 74 are still derived inside one.
