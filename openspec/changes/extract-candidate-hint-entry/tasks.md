...
- [ ] 1.1 `candidateHint(state, ui, findMistakes, buildSteps)` in
...
- [ ] 1.2 Unit-test the three refusal branches + the success pass.
- [ ] 1.3 Replace `hint` in keen/towers/unequal/solo with a one-line `candidateHint` call;
