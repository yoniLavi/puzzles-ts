...
between squares, so the cursor sits on a **corner** instead, and the
arrow keys walk it from corner to corner along the grid's edges. The
...
- **Shift + arrow** aims at an edge leaving your corner in that direction
