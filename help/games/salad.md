...
<dl>
	...
	<dt>Difficulty</dt>
	<dd>Determine the difficulty of the generated puzzle. An Unreasonable puzzle always needs a technique the Normal level does not have, so the setting you choose is the difficulty you get — and it may need one that no hint can teach you, which is what the name warns of. Unreasonable Number Ball puzzles are rare, so one can take a few seconds to appear.</dd>
</dl>
